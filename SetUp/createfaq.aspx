<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage/Admin.master" AutoEventWireup="true" CodeFile="createfaq.aspx.cs" Inherits="SetUp_createfaq" %>
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback" />
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                if (koopId != "http://naaceasy.com/SetUp/createfaq.aspx") {
                    getfaq(koopId);
                    $("#btn_save").val('Update');
                }
                else {
                ...
                $("#btn_save").on('click', function (e) {
                    ...
                    e.preventDefault();
                    var vmfaqobj = {};
                    vmfaqobj.criteriasno = $('#<%=ddl_menu.ClientID %> option:selected').val();
                    vmfaqobj.question = $('#<%=txt_question.ClientID%>').val();
                    vmfaqobj.answer = $("#summernote").val();
                    vmfaqobj.status = $('#<%=ddl_status.ClientID %> option:selected').val();
                    vmfaqobj.type = type;
                    vmfaqobj.faqsno = koopId;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(customers, function () {
                            ...
                            $('#<%=txt_question.ClientID%>').val($(this).find("faqquestion").text());
                            $('#<%=ddl_status.ClientID %>').val($(this).find("faqstatus").text());
                            var faqanswer = $(this).find("faqanswer").text();

                            $("#summernote").summernote("code", faqanswer);
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="#">Create FAQ</a></li>
            <li class="breadcrumb-item active">Add/Update Faq</li>
          </ol>
        </div>
      </div>
    </div>
                ...
                <div class="form-group">
                       <div class="row">
                            ...
                            <div class="col-md-6">
                                 ...
                                 <asp:TextBox ID="txt_question" runat="server" class="form-control" AutoComplete="off"></asp:TextBox>
                                </div>
                            <div class="col-md-6">
