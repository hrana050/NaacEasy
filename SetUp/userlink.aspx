<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage/Admin.master" AutoEventWireup="true" CodeFile="userlink.aspx.cs" Inherits="SetUp_userlink" %>
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="pnllevelChkbx" runat="server" Height="300px" Width="250px" Style="overflow: auto;" CssClass="checkbox">
                                    ...
                                    <asp:CheckBoxList ID="chkbxlevelPageList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="chkbxlevelPageList_SelectedIndexChanged" RepeatDirection="Vertical"></asp:CheckBoxList>
                                </asp:Panel>
                            </td>
