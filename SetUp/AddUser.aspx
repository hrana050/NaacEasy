<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage/Admin.master" AutoEventWireup="true" CodeFile="AddUser.aspx.cs" Inherits="SetUp_AddUser" %>
    ...
    <script type="text/javascript">
        ...
        function CheckuserAvailability() {
            ...
            $.ajax({
                ...
                data: '{usercontact: "' + $("#<%=txt_name.ClientID%>")[0].value + '" }',
                ...
                <div class="form-group">
                    <div class="row">
                          <div class="col-md-5">
                             ...
                             <asp:TextBox ID="txt_empname" runat="server" class="form-control" AutoComplete="off"></asp:TextBox>
                        </div>
                 <div class="col-md-1" style="margin-top: 30px;">
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_name" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                </div>
                          <div class="col-md-5">
                             <label for="inputName">User Name</label>
                             <asp:TextBox ID="txt_name" runat="server" class="form-control" AutoComplete="off" onchange="CheckuserAvailability()"></asp:TextBox>
                              <span id="spnMsg"></span>
                        </div>
                 <div class="col-md-1" style="margin-top: 30px;">
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_name" ErrorMessage="*" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                          ...
                          <div class="row">
                              <div class="col-md-5" runat="server" id="pwd">
                  <label for="inputName">Password</label>
                   <asp:TextBox ID="txt_pwd" runat="server" class="form-control" AutoComplete="off"></asp:TextBox>
                        </div>
                         <div class="col-md-1" style="margin-top: 30px;" runat="server" id="pwderror">
